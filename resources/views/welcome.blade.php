...
<div class="sidebar d-none d-md-block">
    ...
    <a href="{{ route('data.kategori') }}">Lihat Data</a>
        ...
        <div class="col-md-9 main-content">
            <div class="card">
                <h2 class="mb-3 text-center">Selamat Datang</h2>
                <p class="text-center">Silakan masuk atau daftar untuk mulai menggunakan aplikasi.</p>
...
<div class="mobile-nav d-md-none">
    ...
    <a href="{{ route('data.kategori') }}" class="{{ request()->routeIs('data.kategori') ? 'active' : '' }}">Data</a>
